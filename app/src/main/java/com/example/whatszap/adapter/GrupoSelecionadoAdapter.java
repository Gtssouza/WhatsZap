...
public class GrupoSelecionadoAdapter extends RecyclerView.Adapter<GrupoSelecionadoAdapter.MyViewHolder> {
    ...
    public GrupoSelecionadoAdapter(List<Usuario> listaContatos, Context con) {

        this.contatosSelect = listaContatos;
        this.context = con;
    }
    ...
    public void onBindViewHolder(@NonNull GrupoSelecionadoAdapter.MyViewHolder holder, int position) {
        ...
        Usuario usuario = contatosSelect.get(position);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            foto = itemView.findViewById(R.id.circleImageUserSelect);
            nome = itemView.findViewById(R.id.txtNomeUserSelect);
        }
    }
